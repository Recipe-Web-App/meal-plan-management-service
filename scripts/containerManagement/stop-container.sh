...
echo "🛑 Stopping Meal Plan Management Service containers..."
print_separator "="
...
kubectl scale deployment meal-plan-management-service --replicas=0 -n "$NAMESPACE"
...
print_separator "="
print_status "ok" "Meal Plan Management Service containers stopped"
